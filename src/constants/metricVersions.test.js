...
describe('METRIC_VERSIONS', () => {
  it('covers every game that participates in Benchmark, plus Sudoku, Marble Jump, Mental Rotation, Emoji Mahjong, Number Match and Odd One Out (Benchmark-excluded but still games)', () => {
    const expectedGames = [
