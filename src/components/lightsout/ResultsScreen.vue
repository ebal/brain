<template>
  <div class="results">
    ...
    <p class="level-name">Level {{ results.level }} &middot; {{ results.size }}×{{ results.size }}</p>
    ...
    <div class="stats-grid">
      ...
      <div class="stat">
        ...
        <span class="value">{{ best ? formatTime(best.duration) : '—' }}</span>
      </div>
    </div>
...
const { recordCompletion, getStats } = useLightsOutStats()
...
const hasNextLevel = computed(() => props.results.level < LIGHTSOUT_LEVELS.length)
